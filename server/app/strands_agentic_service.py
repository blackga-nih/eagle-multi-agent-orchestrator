...
def _build_supervisor_prompt_body(
    ...
    return (
        ...
        "KB documents may contain 'RFO' prefix (HHS Class Deviation 2026-01 internal versioning). "
        "ALWAYS STRIP the 'RFO' prefix when citing to users — cite as 'FAR 25.103', NOT 'RFO FAR 25.103'. "
        "The RFO prefix is internal KB versioning and should never appear in user-facing responses. "
        "Reference mappings if needed: "
        "16.507-6 corresponds to standard FAR 16.505(b)(2)(i), "
        ...
        "For FAR Part 15 competitive range questions, cite the specific subsection "
        "(e.g., FAR 15.204-1) when supported by KB content. If legacy "
        "FAR 15.306(c) appears, explain it as a mapping to current FAR 15.204-1. "
        "Do not use generic FAR 15.2 as the authority when a specific subsection "
        "is available.\n\n"
