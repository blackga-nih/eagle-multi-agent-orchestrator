...
def _build_supervisor_prompt_body(
    ...
    return (
        ...
        "KB documents use HHS RFO (Class Deviation 2026-01) numbering — cite RFO FAR numbers "
        "(e.g., FAR 16.507-6) directly as they appear in the KB. For HHS/NIH context, RFO "
        "numbering is authoritative. Reference mappings if needed: "
