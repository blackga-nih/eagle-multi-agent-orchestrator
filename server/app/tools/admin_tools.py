...
def exec_manage_prompts(params: dict, tenant_id: str) -> dict:
    from app.prompt_store import delete_prompt, get_prompt, list_tenant_prompts, put_prompt, resolve_prompt
    ...
    if action == "set":
        ...
        item = put_prompt(tenant_id=tenant_id, agent_name=agent_name, prompt_body=prompt_body, is_append=params.get("is_append", False))
...
def exec_manage_templates(params: dict, tenant_id: str) -> dict:
    from app.template_store import delete_template, get_template, list_tenant_templates, put_template, resolve_template
