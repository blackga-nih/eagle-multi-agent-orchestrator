...
class RuntimeContextManager:
    ...
    @staticmethod
    def build_prompt_session_attributes(
        tenant_id: str, user_id: str, message_context: Optional[Dict] = None
    ) -> Dict[str, str]:
        """
    ...
    def extract_tenant_context_from_trace(trace_data: Dict) -> Dict[str, Any]:
        ...
        """
        context = {"tenant_metrics": {}, "processing_steps": [], "resource_usage": {}}
        ...
        if "orchestrationTrace" in trace_data:
            ...
            if "modelInvocationInput" in orchestration:
                ...
                context["resource_usage"]["model_id"] = model_input.get(
                    "foundationModel"
                )
            ...
            if "knowledgeBaseLookupInput" in orchestration:
                ...
                context["resource_usage"]["knowledge_base_id"] = kb_input.get(
                    "knowledgeBaseId"
                )
            ...
            if "actionGroupInvocationInput" in orchestration:
                ...
                context["resource_usage"]["action_group"] = ag_input.get(
                    "actionGroupName"
                )
    ...
    def build_tenant_usage_summary(
        trace_contexts: list, tenant_id: str
    ) -> Dict[str, Any]:
        """
        ...
        for trace_context in trace_contexts:
            ...
            if pattern:
                summary["processing_patterns"][pattern] = (
                    summary["processing_patterns"].get(pattern, 0) + 1
                )
