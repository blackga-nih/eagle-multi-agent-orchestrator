"""Package Document Store -- DynamoDB-backed DOCUMENT# entity CRUD with version tracking.

Stores agent-generated acquisition documents (SOW, IGCE, etc.) tied to
packages. Supports versioning with automatic supersession of prior versions.
Separate from user_document_store.py which handles user uploads (USER_DOC# prefix).
