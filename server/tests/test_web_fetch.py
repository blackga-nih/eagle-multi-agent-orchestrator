...
@patch("app.tools.web_fetch.exec_web_fetch")
def test_web_fetch_tool_in_supervisor_tools(mock_exec):
    """_build_kb_service_tools() returns 5 tools including web_fetch."""
    ...
    assert len(tools) == 5
    assert "web_fetch_tool" in tool_names or "web_fetch" in tool_names
