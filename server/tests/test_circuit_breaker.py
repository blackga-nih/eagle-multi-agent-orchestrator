...
def test_model_chain_has_accessible_models():
    """The default chain should only contain accessible models with Haiku as last resort."""
    from app.strands_agentic_service import _DEFAULT_MODEL_CHAIN, _MODEL_CHAIN_IDS

    assert len(_MODEL_CHAIN_IDS) >= 2
