 ...
 */
export async function getEagleDB(userId: string, tenantId: string): Promise<EagleDB | null> {
...
export async function idbGetSession(db: EagleDB, sessionId: string): Promise<IDBSession | null> {
  try {
...
export async function idbPutSession(db: EagleDB, session: IDBSession): Promise<void> {
  try {
...
export async function idbGetAllSessions(db: EagleDB, userId: string): Promise<IDBSession[]> {
  try {
...
export async function idbDeleteSession(db: EagleDB, sessionId: string): Promise<void> {
  try {
...
export async function idbGetMessages(db: EagleDB, sessionId: string): Promise<IDBMessage[]> {
  try {
