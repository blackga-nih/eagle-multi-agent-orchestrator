...
const features = [
  {
    ...
    title: 'Chat',
    description:
      'AI-powered assistant for acquisition tasks, FAR/DFARS search, and document guidance',
    href: '/chat',
    color: 'text-blue-600',
    bgColor: 'bg-blue-50',
  },
          ...
          <div className="max-w-6xl w-full flex flex-col lg:flex-row gap-12 lg:gap-16">
            ...
            <div className="lg:w-2/5 flex flex-col justify-center">
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Empowering the NCI Office of Acquisitions with intelligent tools that streamline
                procurement workflows, automate document generation, and provide instant access to
