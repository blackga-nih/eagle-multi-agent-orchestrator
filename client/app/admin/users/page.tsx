...
import { getUserRoleColor, getUserRoleLabel, formatDate } from '@/lib/format-helpers';
  ...
  const columns: Column<BackendUser>[] = [
    ...
    },
    {
      ...
      render: (user) => {
        ...
        return role ? (
          <span
            className={`text-[10px] font-bold uppercase px-2 py-1 rounded-full ${getUserRoleColor(role)}`}
          >
    ...
    },
    {
      ...
      header: 'Sessions',
      sortable: true,
      render: (user) => <span className="text-sm text-gray-600">{user.session_count ?? '-'}</span>,
    },
    {
      key: 'last_active',
      header: 'Last Active',
    ...
    <AuthGuard>
      <div className="flex flex-col h-screen bg-gray-50">
        ...
        <Modal
          ...
          title={
            selectedUser
              ? `User: ${selectedUser.display_name || selectedUser.user_id}`
              : 'User Details'
          }
          size="md"
          footer={
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl">
                <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full flex items-center justify-center text-white font-bold text-xl">
                  {(selectedUser.display_name || selectedUser.user_id || '?')
                    .substring(0, 2)
                    .toUpperCase()}
                </div>
                <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm font-medium">
                    {selectedUser.total_cost ? `$${selectedUser.total_cost}` : '-'}
                  </p>
                </div>
                <div>
                  <label className="text-xs text-gray-500 uppercase tracking-wide">
        ...
        >
          <div className="text-center py-8">
            ...
            <p className="text-xs text-gray-400 mt-1">
              Contact your administrator for group changes.
            </p>
          </div>
        </Modal>
        ...
        >
          <div className="text-center py-8">
            <p className="text-sm text-gray-500">
              User provisioning is handled through AWS Cognito.
            </p>
            <p className="text-xs text-gray-400 mt-1">
