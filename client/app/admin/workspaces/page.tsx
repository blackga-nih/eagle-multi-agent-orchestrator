                  ...
                  >
                    ...
                    <div className="p-5">
                      <div className="flex items-start justify-between mb-3">
                        <div
                          className={`p-3 rounded-xl ${ws.is_active ? 'bg-green-100' : 'bg-gray-100'}`}
                        >
                          <Layers
                            className={`w-6 h-6 ${ws.is_active ? 'text-green-600' : 'text-gray-500'}`}
                          />
                        </div>
                        <div className="flex items-center gap-2">
                          {ws.is_default && (
                      ...
                      <div className="flex items-center gap-3 text-xs text-gray-500">
                        ...
                        <span>
                          {ws.override_count} override{ws.override_count !== 1 ? 's' : ''}
                        </span>
                      ...
                      <div className="border-t border-gray-100 bg-gray-50 p-4 rounded-b-2xl">
                        {overrides.length > 0 ? (
                          <div className="space-y-2">
                            {overrides.map((o) => (
                              ...
                              >
                                ...
                                <button
                                  onClick={() =>
                                    handleRemoveOverride(ws.workspace_id, o.entity_type, o.name)
                                  }
                          ...
                          <p className="text-sm text-gray-400 text-center py-4">
                            No overrides in this workspace
                          </p>
                        )}
                      </div>
                    )}
