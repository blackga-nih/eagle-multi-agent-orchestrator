...
const quickActions = [
  ...
  { label: 'Document Templates', href: '/admin/templates', icon: <FileStack className="w-5 h-5" /> },
          ...
          <div className="grid lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-200 p-6">
              ...
              <div className="text-center py-8">
                ...
                <p className="text-xs text-gray-400 mt-1">Session and document events will appear here.</p>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <div className="flex items-center gap-3 p-4 bg-green-50 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-sm text-green-600">{loading ? 'Checking...' : dashboardData ? 'Connected' : 'Unavailable'}</p>
                </div>
              </div>
            </div>
          </div>
