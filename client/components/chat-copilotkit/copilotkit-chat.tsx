        ...
        return (
          <div className="my-2 p-4 bg-white border border-[#D8DEE6] rounded-lg shadow-sm">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="font-medium text-sm text-[#1A2332]">{args.title}</span>
...
When generating documents, use the view_document action to display them.`}
      icons={{
        sendIcon: <span className="text-base">&#10148;</span>,
      }}
    />
  );
}
  ...
  return (
    <div className="h-full flex bg-[#F5F7FA]">
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        <CopilotKit runtimeUrl={RUNTIME_URL} agent="eagle" useSingleEndpoint={false}>
      ...
      {panelOpen ? (
        <div className="w-[340px] shrink-0 border-l border-[#D8DEE6] bg-white flex flex-col">
          ...
          <div className="flex-1 min-h-0">
            <AGUIActivityLog events={events} onClear={handleClear} isStreaming={isStreaming} />
          </div>
        </div>
      ) : (
        <button
