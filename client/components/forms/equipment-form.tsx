...
export default function EquipmentFormModal({ open, onClose, onSubmit }: EquipmentFormModalProps) {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div
        data-testid="modal-equipment-form"
        className="bg-white rounded-lg shadow-xl w-[80vw] max-h-[90vh] overflow-y-auto"
      >
