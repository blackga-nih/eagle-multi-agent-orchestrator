            ...
            return (
              <div key={cmd.id} className="group relative">
                ...
                >
                  ...
                  <span className={`text-xs font-medium ${colors.text}`}>{cmd.name}</span>
                </button>
                <div
  ...
  return (
    ...
    >
      <div
        ...
        className="w-[80vw] bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden animate-in zoom-in-95 slide-in-from-bottom-4 duration-200"
      >
        {/* Header */}
